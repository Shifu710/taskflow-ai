...
const sections = [
  ...
  ["Known limitations", "Public demo tools use seeded demo data. External write tools are simulated in public demo mode. SQLite is quick-demo mode. Celery/Redis worker mode and Alembic migrations are wired, but active scheduled trigger execution and real Langfuse trace sending still need production hardening."],
