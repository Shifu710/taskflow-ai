...
const sections = [
  ...
  ["Files to review", "apps/api/app/runtime/engine.py contains the LangGraph nodes and conditional edges. apps/api/app/runtime/state.py defines AgentRunState. apps/api/app/services/tool_gateway.py performs schema-validated tool invocation and retry logging. apps/api/app/api/routes.py wires run creation, approval resume/reject, replay, SSE, usage, and MCP-style routes. apps/api/app/tests/test_langgraph_runtime.py verifies graph behavior."],
